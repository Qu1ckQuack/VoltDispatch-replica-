...
export const workOrdersApi = {
  ...
  startTravel: (id: string) =>
    api.patch<WorkOrder>(`/work-orders/${id}/start-travel`).then((r) => r.data),

  startWork: (id: string) =>
    api.patch<WorkOrder>(`/work-orders/${id}/start-work`).then((r) => r.data),
  ...
  resolveIssue: (id: string) =>
    api.patch<WorkOrder>(`/work-orders/${id}/resolve-issue`).then((r) => r.data),
